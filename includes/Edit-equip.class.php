...
class Edit_equip{
    public static function Editar_equipo($token){
        ...
        if (!isset($data['nombre_equipo'],$data['caracteristicas_del_sistema'],$data['numero_serial'],$data['nombre_agente'],$data['fecha_de_adquisicion'],$data['modelo_equipo'],$data['imagen_equipo'],$data['descripcion_equipo'],$data['estado_equipo'],$data['depreciacion_equipo'],$data['proveedor_equipo'],$data['ubicacion_equipo'], $data['costo_adquisicion'], $data['vida_util_equipo'],$data['valor_residual'], $data['id_equipo'])) {
