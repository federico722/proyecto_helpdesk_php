...
class Obteniendo_los_servicios_licencias_asociados{
    public static function obteniendo_servicios_licencias_asociados_al_equipo($token, $nombre_equipo){
    try {
    ...
    $stmt = $conn->prepare('CALL ObtenerDatosPorEquipo(:nombre_equipo)');
