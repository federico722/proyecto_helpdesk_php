...
require_once '..\..\includes\Obtener-servicios-ordenados-con-fecha.class.php';
    ...
    if (isset($headers['Authorization'])) {
        ...
        if (strcasecmp($type, 'Bearer') === 0) {
            // Llama a la función de verificación con el token extraído
             Obteniendo_servicios_ordenados_usando_fecha::obteniendo_servicios_ordenados_usando_fecha($token, $_GET['fecha_Actual']);
        }else {
