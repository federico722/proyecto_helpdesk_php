...
require_once '..\..\includes\Obteniendo-costos-equipos-licencias-servicios.class.php';
    ...
    if (isset($headers['Authorization'])) {
        ...
        if (strcasecmp($type, 'Bearer') === 0) {
            // Llama a la función de verificación con el token extraído
             Obteniendo_costos_equipos_servicios_licencias::obteniendo_costos_equipos_servicios_licencias($token);
        }else {
