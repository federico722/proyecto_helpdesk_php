<?php
 ...
 require_once '..\..\includes\obtener-cantidad-servicio-licencia-equipos.class.php';
 ...
 header('Access-Control-Allow-Credentials: true'); // Si es necesario para permitir credenciales
    ...
    if (isset($headers['Authorization'])) {
        ...
        if (strcasecmp($type, 'Bearer') === 0) {
            ...
            Obteniendo_los_servicios_licencias_con_el_nombre_de_equipo::obteniendo_servicios_licencias_usando_nombre_equipo($token, $_GET['nombre_equipo']);
        }else {
