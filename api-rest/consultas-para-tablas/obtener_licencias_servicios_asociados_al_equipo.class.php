<?php
 ...
 require_once '..\..\includes\Obtener-servicios-licencias-asociados-al-equipo.class.php';
 ...
 header('Access-Control-Allow-Credentials: true'); // Si es necesario para permitir credenciales
    ...
    if (isset($headers['Authorization'])) {
        ...
        if (strcasecmp($type, 'Bearer') === 0) {
            ...
            Obteniendo_los_servicios_licencias_asociados::obteniendo_servicios_licencias_asociados_al_equipo($token, $_GET['nombre_equipo']);
        }else {
